...
st.title("OAS Eligibility & Timeline with Gaps Highlighted")
st.write("Visualize your residence history after age 18 with gaps and color-coded periods for OAS eligibility.")
...
# --- Display periods with remove buttons ---
...
if not df.empty:
    st.write("---")
    st.subheader("Interactive Residence Timeline with Gaps")
